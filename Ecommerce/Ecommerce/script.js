...
window.addEventListener("scroll", function(){
  ...
  const targetNumber = window.innerHeight = 1600;
...
//  const scrollNumber = window.scrollY;
// //  const targetNumber = window.innerHeight >= 
// });
...
//   if(scrollNumber >= targetNumber) {
//       navContainer.classList.add("products");
//   } 
//   else{
//       navContainer.classList.remove("categories");
//   }
